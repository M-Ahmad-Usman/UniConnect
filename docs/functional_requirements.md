...
| General      | Discussions      | #general       | Any active member of the server, unless the channel is locked            |
...
| ID    | Requirement                                                                                                                                |
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| FR-35 | Authorized users can create posts in channels in which they are authorized; any active server member can post in unlocked General channels |
...
| FR-40 | Author/Admin can delete posts (soft delete); notifications linked to deleted posts are removed                                             |
...
| Student           | ✅ General channel                              | ✅ General channel                               | ✅ General channel                              |
